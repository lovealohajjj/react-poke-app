  ...
  return (
    <div className="relative z-50">
      ...
      >
        ...
        <button
          type="submit"
          className="text-xs bg-slate-900 text-slate-300 w-[2.5rem] h-6 px-2 py-1 rounded-r-lg text-center absolute right-0 hover:bg-slate-700 z-0"
        >
          검색
        </button>
      </form>
      ...
      {checkEqualName(searchTerm).length > 0 && (
        ...
        >
          ...
          ></div>
          <ul
            className={`w-40 max-h-[134px] py-1 bg-gray-700 rounded-lg absolute top-0 overflow-auto scrollbar-hide`}
          >
